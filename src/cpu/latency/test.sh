...
for cts in $PMClist
do
$ass -f elf64 -o b64.o -Dinstruct1=$instruct1 -Dregtype1=$regtype1 -Dregtype2=$regtype2 -Dnumimm=$numimm -Dimmvalue=$immvalue -Drepeat1=$repeat1 -Dcounters=$cts -Dtmode=L -Pconvers.inc TemplateB64.nasm
if [ $? -ne 0 ] ; then
  echo "assembling $instruct1 failed."
  echo "assembling $instruct1 failed." >> results1/convers.txt
else
...
for cts in $PMClist
do
$ass -f elf64 -o b64.o -lTTT -Dinstruct1=$instruct1 -Dregtype1=$regtype1 -Dregtype2=$regtype2 -Dnumimm=$numimm -Dimmvalue=$immvalue -Drepeat1=$repeat1 -Dcounters=$cts -Dtmode=L -Pconvers.inc TemplateB64.nasm
if [ $? -ne 0 ] ; then
  echo "assembling $instruct1 failed."
  echo "assembling $instruct1 failed." >> results1/convers.txt
  exit #!!
...
# ADD Throughput
instruct3=OR
echo -e "\n\nThroughput: $instruct1 $regtype2, $regtype1 / $instruct2 $regtype1, $regtype2 / $instruct3 $regtype1,$regtype1" >> results1/convers.txt
$ass -f elf64 -o b64.o -Dinstruct1=$instruct1 -Dinstruct2=$instruct2 -Dinstruct3=$instruct3 -Dregtype1=$regtype1 -Dregtype2=$regtype2 -Dnumimm=$numimm -Dimmvalue=$immvalue -Drepeat1=$repeat1 -Dtmode=T -Pconvers.inc TemplateB64.nasm
if [ $? -ne 0 ] ; then
  echo "assembling $instruct1 failed"
  echo "assembling $instruct1 failed" >> results1/convers.txt
else
...
$ass -f elf64 -o b64.o -Dinstruct1=$instruct1 -Dregtype1=$regtype1 -Dregtype2=$regtype2 -Dnumimm=$numimm -Dimmvalue=$immvalue -Drepeat1=$repeat1 -Dtmode=T -Pconvers.inc TemplateB64.nasm
if [ $? -ne 0 ] ; then
  echo "assembling $instruct1 failed"
  echo "assembling $instruct1 failed" >> results1/convers.txt
else
...
for cts in $PMClist
do
$ass -f elf64 -o b64.o -Dinstruct1=$instruct2 -Dregtype1=$regtype2 -Dregtype2=$regtype1 -Dnumimm=0 -Drepeat1=$repeat1 -Dcounters=$cts -Dtmode=L -Pconvers.inc TemplateB64.nasm
if [ $? -ne 0 ] ; then
  echo "assembling $instruct1 failed"
  echo "assembling $instruct1 failed" >> results1/convers.txt
else
...
#ADD Throughput
echo -e "\n\nThroughput: $instruct2 $regtype1, $regtype2"  >> results1/convers.txt
$ass -f elf64 -o b64.o -Dinstruct1=$instruct2 -Dregtype1=$regtype1 -Dregtype2=$regtype2 -Dnumimm=0 -Drepeat1=$repeat1 -Dtmode=T -Pconvers.inc TemplateB64.nasm
if [ $? -ne 0 ] ; then
  echo "assembling $instruct1 failed"
  echo "assembling $instruct1 failed" >> results1/convers.txt
else
